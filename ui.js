...
export const UI = {
    ...
    async open() {
        ...
        panel.innerHTML = `
            ...
            <div class="wb-content">
                ...
                <div id="wb-view-editor" class="wb-view-section">
                    ...
                    <div class="wb-preset-strip" style="display:flex; gap:8px; margin-bottom:10px; align-items:center;">
                        <select id="wb-preset-selector" class="wb-input-dark" style="flex:1; padding:4px 8px;"></select>
                        <button class="wb-btn-rect mini" id="wb-preset-save" style="padding:4px 10px; font-size:0.85em;">保存状态</button>
                        <button class="wb-btn-rect mini" id="wb-preset-apply" style="padding:4px 10px; font-size:0.85em;">应用状态</button>
                        <button class="wb-btn-rect mini" id="wb-preset-delete" style="padding:4px 10px; font-size:0.85em; background:#ef4444; border-color:#dc2626;">删除状态</button>
                    </div>
                    ...
                    <div class="wb-tool-bar">
                        ...
                        <button class="wb-btn-circle" id="btn-toggle-batch-edit" title="批量编辑模式"><i class="fa-solid fa-list-check"></i></button>
                        <button class="wb-btn-circle" id="btn-add-entry" title="新建条目"><i class="fa-solid fa-plus"></i></button>
                    </div>

                    <div class="wb-batch-toolbar wb-hidden" id="wb-batch-toolbar" style="display:flex; flex-wrap:wrap; gap:6px; margin-bottom:10px; padding:10px; background:rgba(0,0,0,0.05); border-radius:8px; align-items:center;">
                        <span id="wb-selection-info" style="font-size:0.9em; font-weight:bold; color:#7c5cbd; margin-right:10px;">已选 0/0</span>
                        <button class="wb-btn-rect mini" id="wb-select-all" style="padding:4px 8px; font-size:0.85em;">全选(可见)</button>
                        <button class="wb-btn-rect mini" id="wb-select-invert" style="padding:4px 8px; font-size:0.85em;">反选(可见)</button>
                        <button class="wb-btn-rect mini" id="wb-select-clear" style="padding:4px 8px; font-size:0.85em; margin-right:10px;">清空选择</button>
                        
                        <button class="wb-btn-rect mini" id="wb-batch-enable" style="padding:4px 8px; font-size:0.85em;">批量开启</button>
                        <button class="wb-btn-rect mini" id="wb-batch-disable" style="padding:4px 8px; font-size:0.85em;">批量关闭</button>
                        <button class="wb-btn-rect mini" id="wb-batch-constant-on" style="padding:4px 8px; font-size:0.85em;">设常驻(蓝)</button>
                        <button class="wb-btn-rect mini" id="wb-batch-constant-off" style="padding:4px 8px; font-size:0.85em; margin-right:10px;">设非常驻(绿)</button>

                        <select id="wb-batch-position" class="wb-input-dark" style="padding:4px; font-size:0.85em;">
                        ...
                        <button class="wb-btn-rect mini" id="wb-batch-position-apply" style="padding:4px 8px; font-size:0.85em; margin-right:10px;">应用位置</button>

                        <input type="number" id="wb-batch-order" class="wb-input-dark" placeholder="起始顺序" style="width:80px; padding:4px; font-size:0.85em;">
                    ...
                    <div class="wb-list" id="wb-entry-list"></div>
                                ...
                                <!-- 视图 4: 缝合世界书 -->
                <div id="wb-view-stitch" class="wb-view-section wb-hidden" style="padding:10px; background:rgba(0,0,0,0.02); border-radius:12px; overflow-y:auto;">
                    <div class="wb-stitch-topbar" style="display:flex; justify-content:space-between; align-items:center; margin-bottom:10px; flex-wrap:wrap; gap:10px;">
                        <div style="display:flex; align-items:center; gap:8px;">
                            <span style="font-weight:bold; color:#6b7280;">拖拽模式:</span>
                            <select id="wb-stitch-mode" class="wb-input-dark" style="padding:4px 10px;"><option value="copy">复制</option><option value="move">移动</option></select>
                        </div>
                        <div style="font-size:0.85em; color:#9ca3af;">提示：把条目拖到另一侧列表即可跨书缝合；移动端可用下方“复制/移动选中”按钮。</div>
                    </div>
                    <div class="wb-stitch-grid" style="display:grid; grid-template-columns:1fr 1fr; gap:15px;">
                        <!-- 左侧 -->
                        <div class="wb-stitch-pane" id="wb-stitch-left-pane" style="background:#fff; border:1px solid #e5e7eb; border-radius:12px; padding:10px; display:flex; flex-direction:column; gap:10px;">
                            ...
                            <div style="display:flex; gap:10px; justify-content:center;">
                                <button class="wb-btn-rect mini" id="wb-stitch-left-copy" style="padding:6px 15px;">复制选中到右侧</button>
                                <button class="wb-btn-rect mini" id="wb-stitch-left-move" style="padding:6px 15px;">移动选中到右侧</button>
                            </div>
                        </div>
                        <!-- 右侧 -->
                        <div class="wb-stitch-pane" id="wb-stitch-right-pane" style="background:#fff; border:1px solid #e5e7eb; border-radius:12px; padding:10px; display:flex; flex-direction:column; gap:10px;">
                            <div style="display:flex; align-items:center; gap:10px;">
                            ...
                            <div style="display:flex; gap:10px; justify-content:center;">
                                <button class="wb-btn-rect mini" id="wb-stitch-right-copy" style="padding:6px 15px;">复制选中到左侧</button>
                                <button class="wb-btn-rect mini" id="wb-stitch-right-move" style="padding:6px 15px;">移动选中到左侧</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="wb-view-binding" class="wb-view-section wb-hidden">
                    <div class="wb-bind-grid">
                        ...
                        <div class="wb-bind-card"><div class="wb-bind-title"><span><i class="fa-solid fa-user-tag"></i> 角色世界书</span></div><div class="wb-bind-label"> 主要世界书</div><div id="wb-bind-char-primary" style="position:relative"></div><div class="wb-bind-label">附加世界书（双击条目可直接进入编辑）</div><div class="wb-scroll-list" id="wb-bind-char-list"></div></div>
        ...
        $('#btn-toggle-batch-edit').onclick = () => this.toggleBatchEditMode();
                ...
                if (selectedSet.size === 0) tagsEl.innerHTML = `<div class="wb-ms-placeholder">点击选择世界书...</div>`;
                    ...
                    selectedSet.forEach(name => {
                        ...
                        tag.ondblclick = async (e) => {
                            e.stopPropagation();
                            await Actions.openBookByName(name);
                        };
                        // --- 新增结束 ---
    ...
    createCard(entry, index) {
        ...
        card.innerHTML = `
            <div class="wb-card-header">
                            <!-- 批量选择复选框 (仅在批量模式下显示) -->
                <div class="wb-header-item wb-item-select wb-select-dot" style="display: none;">
                    <input type="checkbox" class="inp-select" ${selected ? 'checked' : ''} style="width:18px;height:18px;cursor:pointer;">
                </div>
                <!-- 启用开关 -->
    ...
    openContentPopup(entry, triggerBtn) {
        ...
        const close = () => {
            this.clearPopupViewportSync(); // 新增清理
            overlay.remove();
        };
        ...
        const renderGroup = (groupName, items, isCustomTab = false, customBoundMap = null) => {
            ...
            items.forEach(itemName => {
                if (STATE.manageTab === 'worldbook' || STATE.manageTab === 'custom' || isCustomTab) {
                    ...
                    // [二改版移植] 双击卡片直接进入编辑
                    card.ondblclick = () => Actions.jumpToEditor(bookName);
                    if (isCustomTab) {
                        q('.btn-tag').onclick = (e) => {
                            e.stopPropagation();
        ...
        const createOption = (optNode) => {
            ...
            if (selectId === 'wb-book-selector' || selectId === 'wb-bind-char-primary' || selectId === 'wb-bind-chat') {
                div.ondblclick = async (e) => {
                    ...
                    if (!worldName) return;
                    dropdown.remove();
                    await Actions.openBookByName(worldName);
                };
            }
            // --- 新增结束 ---
    ...
    applyBatchEditState() {
        ...
        // 控制卡片里的复选框显隐
        panel.querySelectorAll('.wb-select-dot').forEach(el => {
            el.style.display = STATE.batchEditMode ? 'flex' : 'none';
        });
    },
    ...
    renderStitchSide(sideKey) {
        ...
        if (!all.length) {
            listEl.innerHTML = '<div style="text-align:center;color:#9ca3af;padding:20px;">暂无世界书</div>';
            return;
        }
        ...
        bindBtn(`wb-stitch-${sideKey}-all`, () => {
            ...
            side.entries.forEach(e => {
                if (!term || String(e.comment || '').toLowerCase().includes(term)) side.selected.add(Number(e.uid));
            });
            this.renderStitchSide(sideKey);
        });
        bindBtn(`wb-stitch-${sideKey}-invert`, () => {
            const term = side.search.toLowerCase();
            side.entries.forEach(e => {
                if (!term || String(e.comment || '').toLowerCase().includes(term)) {
                    const uid = Number(e.uid);
                    if (side.selected.has(uid)) side.selected.delete(uid); else side.selected.add(uid);
                }
            });
            this.renderStitchSide(sideKey);
        });
        bindBtn(`wb-stitch-${sideKey}-clear`, () => { side.selected.clear(); this.renderStitchSide(sideKey); });
        ...
        if (!filtered.length) {
            ...
            listEl.innerHTML = filtered.map((entry) => {
                const checked = side.selected.has(Number(entry.uid)) ? 'checked' : '';
                const modeColor = entry.constant ? '#3b82f6' : '#22c55e';
                const modeText = entry.constant ? '常驻' : '非常驻';
                const enableText = entry.disable ? '关闭' : '启用';
                const posText = WI_POSITION_MAP[entry.position] || entry.position;
                
                return `
                    <div class="wb-stitch-item" draggable="true" data-side="${sideKey}" data-uid="${entry.uid}" style="display:flex;align-items:center;gap:10px;padding:8px;border:1px solid #e5e7eb;border-radius:8px;margin-bottom:6px;background:#fff;cursor:grab;">
                        <input type="checkbox" class="wb-stitch-check" data-uid="${entry.uid}" ${checked} style="width:16px;height:16px;cursor:pointer;">
                        <div style="flex:1;min-width:0;">
                            <div style="font-weight:bold;color:#374151;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">${entry.comment || `条目 ${entry.uid}`}</div>
                            <div style="font-size:0.8em;color:#6b7280;display:flex;gap:8px;margin-top:2px;">
        ...
        listEl.querySelectorAll('.wb-stitch-check').forEach(cb => {
            cb.onchange = (e) => {
                const uid = Number(e.target.dataset.uid);
                if (e.target.checked) side.selected.add(uid); else side.selected.delete(uid);
            };
        });
        ...
        listEl.ondragover = (e) => { e.preventDefault(); listEl.style.borderColor = '#3b82f6'; };
        listEl.ondragleave = () => { listEl.style.borderColor = '#f3f4f6'; };
        listEl.ondrop = async (e) => {
            e.preventDefault();
            listEl.style.borderColor = '#f3f4f6';
    ...
    initEntryListDelegation() {
        ...
        list.addEventListener('change', (e) => {
            ...
            if (!card) return;
            const uid = Number(card.dataset.uid);
                        if (e.target.classList.contains('inp-select')) {
                Actions.selectEntry(uid, e.target.checked);
                return;
            }
