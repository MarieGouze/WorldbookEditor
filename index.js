...
const UI = {
    ...
    async open() {
        ...
        // [修复] 使用 addEventListener，确保与 applyCustomDropdown 中的 UI 更新逻辑共存
    ...
    applyCustomDropdown(selectId) {
        ...
        update();
        // [修复] 使用 addEventListener 防止覆盖 Actions.loadBook 的逻辑
